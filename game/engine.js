/* GENERATED by game/build-engine.js — do not edit by hand.
...
function createEngine(){
  ...
  const EN_UI = {
   ...
   move_k:"Move &middot; {0}", move_h:"{0}, {1} steps to spend",
  ...
  const HE_UI = {
   ...
   blind_pick_k:"כולם חוץ מ{0} &mdash; בחרו לו מילה", blind_pick_d:"{0}, תסתובבו עכשיו. כל השאר בוחרים מה הוא צריך לנחש.",
   blind_look:"{0} &mdash; תמשיכו להסתכל הצידה", blind_word:"המילה", blind_ready:"כולם ראו &mdash; מתחילים את השעון",
   blind_table_h:"מילה אחת מכל אחד, סביב השולחן.", blind_table_d:"כל אחד אומר מילה אחת. {0} יכול לצעוק ניחוש מתי שהוא רוצה, כמה פעמים שהוא רוצה.",
   blind_got:"{0} קלט/ה",
   w_word:"המילה {0}+", w_wrong:"צעקה שגויה {0}&minus;", w_early:"נפתר מהר מדי 1+",
   w_mid:"נחת יפה {0}+", w_late:"נחת מאוחר {0}+", w_helped:"עזרו 1+", w_shot:"כיוון נכון 2+", w_partner:"השותף קלט {0}+", w_double:"הוכפל ל&#8209;{0}",
   ...
   move_k:"תזוזה &middot; {0}", move_h:"{0}, {1} צעדים להוציא",
   ...
   hands_k:"קלפים ביד", evidence_k:"קלפים שנצברו", evidence_d:"{0} יכולים לקחת קלף.",
