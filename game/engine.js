...
function createEngine(){
  ...
  const EN_WORDS = {
   2:["couch","spoon","elephant","socks","pizza","umbrella","mirror","ladder","pillow","kettle",
      ...
      "fork","knife","plate","bowl","mug","glass","straw","napkin","tray","jug",
      "corkscrew","tin opener","whisk","rolling pin","frying pan","saucepan","oven","microwave","blender","chopping board",
      "colander","grater","peeler","jar","tin","bottle","cork","lid","ladle","dishcloth",
      "oven glove","sieve","teabag","sugar cube","salt shaker","armchair","wardrobe","bedside table","curtain rail","lightbulb",
      "switch","plug","socket","extension lead","radiator","fireplace","doormat","letterbox","balcony","attic",
      "basement","garage","shed","greenhouse","hammock","deckchair","clothesline","bin","dustpan","mop",
      "feather duster","laundry basket","coat hanger","shoe rack","saw","drill","nail","screw","spanner","pliers",
      "tape measure","spirit level","toolbox","rope","watering can","lawnmower","rake","spade","plant pot","seed",
      "hose","hat","cap","shirt","trousers","jeans","skirt","dress","jumper","coat",
      "pyjamas","swimsuit","tie","bow tie","boot","sandal","trainer","earring","necklace","bracelet",
      "ring","wristwatch","handbag","notebook","diary","chalk","blackboard","whiteboard","sharpener","folder",
      "paperclip","rubber band","sticky note","pin","pinboard","crayon","compass","protractor","abacus","globe",
      "drum","violin","piano","flute","trumpet","harmonica","microphone","speaker","record player","radio",
      "television","remote control","camera","tripod","telescope","binoculars","kite","skateboard","scooter","skipping rope",
      "hula hoop","chess board","dice","playing cards","domino","teddy bear","doll","yo-yo","tree","flower",
      "leaf","cactus","mushroom","acorn","pinecone","shell","pebble","feather","nest","beehive",
      "anthill","rainbow","cloud","lightning","snowflake","icicle","puddle","rock","river","waterfall",
      "lion","tiger","bear","wolf","fox","rabbit","mouse","goat","sheep","cow"],
   3:["jealous","whisper","stubborn","neighbour","rescue","promise","gossip","holiday","shortcut","argument",
      ...
      "punctual","anxious","cheerful","gloomy","grumpy","moody","cranky","sleepy","hungry","thirsty",
      "dizzy","ticklish","nosy","bossy","loyal","honest","humble","vain","modest","charming",
      "stingy","spoiled","lazy","hardworking","patient","reckless","cautious","gentle","fierce","timid",
      "confident","insecure","jumpy","giddy","fed up","heartbroken","speechless","starstruck","tongue-tied","wide awake",
      "half asleep","in a hurry","running late","fast asleep","out of breath","soaking wet","freezing","boiling","starving","stuffed",
      "broke","tired of waiting","wound up","worn out","cheered up","left out","shown up","told off","taken aback","caught out",
      "put out","a handshake","a kiss on the cheek","a wave","a wink","a nod","a shrug","a stare","a polite smile","a frown",
      "a blush","an eye roll","a sigh","a giggle","a shout","a mumble","an interruption","an awkward pause","a bad joke","a pun",
      "a story you have heard before","a long goodbye","a short visit","an uninvited guest","an empty chair","a folding bed","a shared umbrella","a lift home","a borrowed jumper","a returned book",
      "a book never returned","a borrowed charger","a round of drinks","a toast","a card everyone signs","an office birthday","a whip-round","a leaving party","a welcome home","a call from home",
      "a voicemail from your mother","a text you did not answer","a message you regret","a silence on the phone","a name you forgot","a face you know from somewhere","a small favour","a big ask","a promise you kept","a promise you broke",
      "an unpaid debt","a shared secret","a family rule","a house rule","a seating plan","the good plates","the spare room","the guest towel","the family album","a rota",
      "a chore chart","a school report","a permission slip","a note from your mother","a signed form","an appointment","a cancellation","a reschedule","a no-show","a late arrival",
      "the first to leave","a queue of two","a shared taxi","a lost umbrella","a found wallet","directions from a stranger","the wrong stop","a missed train","a saved seat","a held door",
      "a nod to a neighbour","a borrowed pen","a shared table","a stolen chip","a split dessert","a birthday you forgot","an anniversary","a first date","a break-up","making up",
      "a reconciliation","an argument about nothing","the silent treatment","a truce","a grudge","a compromise","a favour returned","gratitude","sympathy","empathy",
      "forgiveness","patience with a child","a short temper","a long fuse","a soft voice","a raised voice","a firm no","a reluctant yes","a straight answer","a vague answer",
      "a change of plan","a delay","a surprise visit","an early night","a long lunch","a lazy Sunday","a walk after dinner","a shared blanket","a snoring partner","an empty house"],
   4:["Tuesday","awkward","leftovers","expired","overrated","coincidence","reputation","hypocrite","small talk","plot twist",
      ...
      "dark mode","a group video call","a screenshot","a screen recording","a data plan","roaming charges","a dead zone","a weak signal","buffering","a loading spinner",
      "an error message","a captcha","a cookie you accepted","a terms-and-conditions box","an unsubscribe link","a spam folder","a phishing email","a fake review","a five-star rating","a one-star review",
      "the comment section","a pinned comment","a thread","a hashtag","a trending topic","a viral video","an influencer","sponsored content","an ad break","a paywalled article",
      "a clickbait headline","a fact-check","a deepfake","an AI answer","a chatbot","a smart speaker","a fitness tracker","a step goal","a screen curfew","a digital detox",
      "a burner account","an old profile picture","a tagged photo","an untagged photo","a memory that resurfaces","a throwback","a story reply","a message left unanswered","a typing indicator","a last-seen time",
      "a blocked number","a shared location","a video quiz night","a shared document","a version history","tracked changes","autoplay","an infinite feed","a notification badge","battery-saver mode",
      "a bus lane","a night bus","a bike lane","an electric scooter","a car share","a taxi app","a surge price","a cancelled ride","a five-minute walk that takes twenty","a diversion",
      "a level crossing","rush hour","a season ticket","a fare dodger","a ticket barrier","lost property","a queue system","a ticket number","an automated voice","hold music",
      "a call centre","a self-service kiosk","a form in triplicate","proof of address","a passport photo","a visa application","the customs queue","duty free","a boarding group","an aisle seat",
      "an overhead locker","a layover","a red-eye flight","a hotel check-in","a late checkout","a room key that stops working","a minibar","a hostel bunk","a campsite","a service station",
      "a flat pack","a missing screw","an instruction manual","an extended warranty","a service charge","a standing order","a direct debit","an overdraft","a credit score","a loyalty card",
      "a points scheme","a sale that is not a sale","a price match","a bulk buy","a use-by date","a best-before date","a food shop that costs more each week","recycling day","bin collection","noisy neighbours upstairs",
      "a shared wall","a landlord inspection","a broken boiler","a leaky tap","a blown fuse","a smoke alarm at 3am","a spare room turned office","a hallway full of parcels","a doorstep delivery photo","a neighbour who takes your parcels",
      "a group order","a tip for the driver","a table for one","a booking fee","a service that adds a fee","a cancellation policy","a refund that takes ten days","a chargeback","a receipt in your inbox","a paper bill",
      "a job title nobody understands","a team-building day","an all-hands","a performance review","a notice period","a handover","a work anniversary","an office kitchen","a shared fridge","a lunch with your name on it",
      "a hot desk","a standing desk","a stand-up meeting","a calendar block","a do-not-disturb","a slow reply","an urgent email at 9pm","a weekend message","an unread channel","a group project",
      "a study group","an open day","a mock exam","a revision timetable","results day","a graduation","a gap year","a student loan","a first job","a career change",
      "a side hustle","a portfolio","a reference","an unpaid internship","a repeat prescription","a walk-in clinic","an annual check-up","flu season","a physio exercise","a wellbeing day"],
   5:["homesick","bittersweet","deja vu","inside joke","comfort zone","silver lining","wake-up call","second wind","growing pains","empty nest",
      ...
      "a house of cards","the domino effect","a vicious circle","a piece of cake","a walk in the park","an uphill battle","a hard act to follow","a tough nut to crack","a bone to pick","a chip off the old block",
      "the apple of your eye","the black sheep","a lone wolf","an early bird","a night owl","a couch potato","a social butterfly","a party pooper","a backseat driver","a know-it-all",
      "a busybody","a people pleaser","a control freak","a creature of habit","a glutton for punishment","a jack of all trades","a big fish in a small pond","a shoulder to cry on","a listening ear","a helping hand",
      "a second opinion","a sixth sense","a third wheel","the plus side","the downside","a mixed blessing","a double take","a fair-weather friend","an old flame","a lost cause",
      "a long story","a short fuse","a sharp tongue","a poker face","a stiff upper lip","a heavy heart","a light touch","a firm hand","a free hand","an open book",
      "a closed door","an open invitation","a hard no","a soft landing","a rude awakening","a reality check","a nasty surprise","a pleasant surprise","a mixed bag","a tall order",
      "a fool's errand","a pipe dream","a distant memory","a passing phase","a fleeting moment","a slow start","a strong finish","a false start","a fresh coat of paint","a clean bill of health",
      "a new lease of life","a change of scene","a breath of fresh air","a blast from the past","a trip down memory lane","the good old days","a rose-tinted memory","a hard-earned lesson","learning it the hard way","a slap in the face",
      "a kick in the teeth","a pat on the back","a leg up","a head start","a running start","a level playing field","an unfair advantage","a hidden cost","a catch","a loose end",
      "a dead end","a last-ditch attempt","a fighting chance","a slim chance","an outside chance","a sure thing","a safe bet","a wild card","a dark horse","the underdog",
      "a comeback","a downfall","a rise and a fall","a hidden agenda","an ulterior motive","a conflict of interest","a double life","a public face","a private life","a small world",
      "a fresh perspective","blind faith","a blank cheque","a free pass","a get-out clause","a slapdash job","a rush job","a thankless task","a fool's paradise","a false economy",
      "a bad apple","a rotten deal","a raw deal","a fair point","a home run","a game changer","a turning tide","a race against time","a ticking clock","the last minute",
      "a deadline that moves","a moving target","goalposts that move","a slippery customer","a smooth operator","a hard bargain","a fair trade","give and take","a two-way street","a one-way street",
      "a crossroads","a fork in the road","a bridge too far","a burnt bridge","an open wound","a healed scar","a sore loser","a graceful winner","a hollow victory","a moral victory",
      "a small mercy","a saving grace","a redeeming feature","a fatal flaw","an Achilles heel","a weak link","a strong suit","a party trick","a hidden talent","a late bloomer",
      "an old soul","young at heart","a familiar stranger","a passing acquaintance","an unlikely friendship","a slow goodbye","an awkward silence","a long-distance friendship","a friendship that faded","a shared history",
      "common ground","a difference of opinion","agreeing to disagree","a peace offering","an unspoken rule","an open question","a straight face","a nervous laugh","a knowing look","a stolen glance",
      "a second glance","an afterthought","a foregone conclusion","a self-fulfilling prophecy","a happy medium","a necessary risk","a calculated risk","a leap in the dark","a hard-luck story","a happy ending"]
  };
  const HE_WORDS = {
   2:["ספה","כפית","פיל","גרביים","פיצה","מטרייה","מראה","סולם","כרית","קומקום",
      ...
      "מזלג","סכין","צלחת","קערה","ספל","כוס","קשית","מפית","מגש","כד",
      "חולץ פקקים","פותחן קופסאות","מטרפה","מערוך","מחבת","סיר","תנור","מיקרוגל","בלנדר","קרש חיתוך",
      "מסננת","פומפייה","קולפן","צנצנת","קופסת שימורים","בקבוק","פקק שעם","מכסה","מצקת","מטלית",
      "כפפת תנור","נפה","שקית תה","קובייה של סוכר","מלחייה","כורסה","ארון בגדים","שידה","מוט וילון","נורה",
      "מתג","תקע","שקע","מאריך","רדיאטור","קמין","שטיחון","תיבת דואר","מרפסת","עליית גג",
      "מרתף","מוסך","מחסן","חממה","ערסל","כיסא נוח","חבל כביסה","פח","יעה","מגב",
      "מטאטא נוצות","סל כביסה","קולב","מדף נעליים","מסור","מקדחה","מסמר","בורג","מפתח ברגים","פלייר",
      "מטר","פלס","ארגז כלים","חבל","מזלף","מכסחת דשא","מגרפה","את חפירה","עציץ","זרע",
      "צינור","כובע","כובע מצחייה","חולצה","מכנסיים","ג׳ינס","חצאית","שמלה","סוודר","מעיל",
      "פיג׳מה","בגד ים","עניבה","פפיון","מגף","סנדל","נעל ספורט","עגיל","מחרוזת","צמיד",
      "טבעת","שעון יד","תיק יד","מחברת","יומן","גיר","לוח","לוח מחיק","מחדד","תיקייה",
      "אטב נייר","גומייה","פתק דביק","סיכה","לוח שעם","פסטל","מחוגה","מד זווית","חשבונייה","גלובוס",
      "תוף","כינור","פסנתר","חליל","חצוצרה","מפוחית","מיקרופון","רמקול","פטיפון","רדיו",
      "טלוויזיה","שלט","מצלמה","חצובה","טלסקופ","משקפת","עפיפון","סקייטבורד","קורקינט","חבל קפיצה",
      "חישוק","לוח שחמט","קובייה","קלפים","דומינו","דובי","בובה","יו־יו","עץ","פרח",
      "עלה","קקטוס","פטרייה","בלוט","אצטרובל","צדף","חלוק","נוצה","קן","כוורת",
      "קן נמלים","קשת בענן","ענן","ברק","פתית שלג","נטיף קרח","שלולית","סלע","נהר","מפל",
      "אריה","נמר","דוב","זאב","שועל","ארנב","עכבר","עז","כבשה","פרה"],
   3:["מקנא","ללחוש","עקשן","שכן","להציל","הבטחה","רכילות","חופשה","קיצור דרך","ויכוח",
      ...
      "דייקן","חרד","עליז","קודר","נרגן","מצוברח","עצבני","ישנוני","רעב","צמא",
      "מסוחרר","רגיש לדגדוגים","חטטן","שתלטן","נאמן","ישר","צנוע","יהיר","עניו","מקסים",
      "קמצן","מפונק","עצלן","חרוץ","סבלני","פזיז","זהיר","עדין","עז רוח","חששן",
      "בטוח בעצמו","חסר ביטחון","קופצני","מבסוט","נמאס לו","שבור לב","חסר מילים","המום","מגמגם","ער לגמרי",
      "חצי ישן","ממהר","מאחר","ישן עמוק","קצר נשימה","רטוב עד העצם","קופא","רותח","גווע ברעב","שבע מדי",
      "מרושש","עייף מלחכות","מתוח","שחוק","מעודד","מודר","מקופח","ננזף","מופתע לרעה","נתפס",
      "מוטרד","לחיצת יד","נשיקה על הלחי","נפנוף","קריצה","הנהון","משיכת כתפיים","מבט","חיוך מנומס","הזעפת פנים",
      "סומק","גלגול עיניים","אנחה","צחקוק","צעקה","מלמול","הפרעה באמצע","שתיקה מביכה","בדיחה גרועה","משחק מילים",
      "סיפור ששמעת כבר","פרידה ארוכה","ביקור קצר","אורח לא קרוא","כיסא ריק","מיטה מתקפלת","מטרייה משותפת","טרמפ הביתה","סוודר מושאל","ספר שהוחזר",
      "ספר שלא הוחזר","מטען מושאל","סבב שתייה","הרמת כוסית","כרטיס שכולם חותמים עליו","יום הולדת במשרד","התרמה במשרד","מסיבת פרידה","ברוך שובך","שיחה מהבית",
      "הודעה קולית מאמא","הודעה שלא ענית","הודעה שהתחרטת עליה","שתיקה בטלפון","שם ששכחת","פנים מוכרות מאיפשהו","טובה קטנה","בקשה גדולה","הבטחה שקיימת","הבטחה שהופרה",
      "חוב שלא הוחזר","סוד משותף","חוק במשפחה","כלל בבית","סידור הושבה","הכלים הטובים","חדר האורחים","המגבת של האורחים","אלבום המשפחה","תורנות",
      "לוח מטלות","תעודה מבית הספר","אישור הורים","פתק מאמא","טופס חתום","תור אצל רופא","ביטול","דחייה לתאריך אחר","מישהו שלא הגיע","איחור",
      "הראשון שקם ללכת","תור של שניים","מונית משותפת","מטרייה שאבדה","ארנק שנמצא","הכוונה מזר","תחנה לא נכונה","רכבת שהחמצת","מקום ששמרו לך","דלת שמישהו החזיק",
      "הנהון לשכן","עט מושאל","שולחן משותף","צ׳יפס שנגנב מהצלחת","קינוח משותף","יום הולדת ששכחת","יום נישואים","דייט ראשון","פרידה מבן זוג","להשלים",
      "פיוס","ריב על כלום","טיפול השתיקה","הפוגה","טינה","פשרה","טובה שהוחזרה","הכרת תודה","אהדה","אמפתיה",
      "סליחה","סבלנות לילד","פתיל קצר","אורך רוח","קול רך","קול מורם","לא נחרץ","כן מהוסס","תשובה ישירה","תשובה מתחמקת",
      "שינוי בתוכניות","עיכוב","ביקור פתע","ללכת לישון מוקדם","ארוחת צהריים ארוכה","יום ראשון עצלן","הליכה אחרי ארוחה","שמיכה משותפת","בן זוג שנוחר","בית ריק"],
   4:["יום שלישי","מביך","שאריות","פג תוקף","צירוף מקרים","מוניטין","צבוע","שיחת חולין","תפנית בעלילה","קבוצת ווטסאפ",
      ...
      "מצב לילה","שיחת וידאו קבוצתית","צילום מסך","הקלטת מסך","חבילת גלישה","חיובי נדידה","אזור בלי קליטה","קליטה חלשה","באפרינג","גלגל טעינה",
      "הודעת שגיאה","קפצ׳ה","עוגייה שאישרת","תיבת תנאי שימוש","קישור להסרה מרשימה","תיקיית ספאם","מייל פישינג","ביקורת מזויפת","דירוג חמישה כוכבים","ביקורת של כוכב אחד",
      "אזור התגובות","תגובה מוצמדת","שרשור","האשטאג","נושא חם","סרטון ויראלי","משפיען","תוכן ממומן","הפסקת פרסומות","כתבה בתשלום",
      "כותרת מפתה","בדיקת עובדות","דיפ פייק","תשובה של בינה מלאכותית","צ׳אטבוט","רמקול חכם","שעון כושר","יעד צעדים","מגבלת זמן מסך","גמילה מהמסך",
      "חשבון מזויף","תמונת פרופיל ישנה","תמונה מתויגת","תמונה בלי תיוג","זיכרון שצף","תמונה משנים עברו","תגובה לסטורי","הודעה שנשארה בלי תשובה","מישהו מקליד","נראה לאחרונה",
      "מספר חסום","מיקום משותף","חידון בזום","מסמך משותף","היסטוריית גרסאות","מעקב אחר שינויים","הפעלה אוטומטית","פיד אינסופי","נקודה אדומה של התראה","מצב חיסכון בסוללה",
      "נתיב אוטובוסים","אוטובוס לילה","שביל אופניים","קורקינט חשמלי","שיתוף רכב","אפליקציית מוניות","תעריף שיא","נסיעה שבוטלה","חמש דקות הליכה שנמשכות עשרים","מעקף",
      "מפגש מסילה","שעת עומס","כרטיס חופשי חודשי","מישהו שנוסע בלי כרטיס","שער כרטיסים","אבידות ומציאות","מכונת תורים","מספר בתור","קול מוקלט","מוזיקת המתנה",
      "מוקד שירות","עמדת שירות עצמי","טופס בשלושה עותקים","אישור כתובת","תמונת פספורט","בקשת ויזה","תור במכס","דיוטי פרי","קבוצת עלייה למטוס","מושב ליד המעבר",
      "תא אחסון עליון","קונקשן","טיסת לילה","צ׳ק אין במלון","צ׳ק אאוט מאוחר","כרטיס חדר שמפסיק לעבוד","מיני בר","מיטה באכסניה","קמפינג","תחנת דלק בדרך",
      "רהיט להרכבה עצמית","בורג שחסר","הוראות הרכבה","אחריות מורחבת","דמי טיפול","הוראת קבע","חיוב אוטומטי","מינוס בבנק","דירוג אשראי","כרטיס מועדון",
      "צבירת נקודות","מבצע שהוא לא מבצע","השוואת מחיר","קנייה בכמות","תאריך אחרון לשימוש","עדיף לפני","קניות שמתייקרות כל שבוע","יום מיחזור","פינוי אשפה","שכנים רועשים מלמעלה",
      "קיר משותף","ביקורת של בעל הדירה","דוד שהתקלקל","ברז שמטפטף","פיוז שקפץ","גלאי עשן בשלוש לפנות בוקר","חדר עבודה שהיה חדר אורחים","מסדרון מלא חבילות","תמונה של החבילה בדלת","שכן שלוקח לך את החבילות",
      "הזמנה משותפת","טיפ לשליח","שולחן לאחד","דמי הזמנה","שירות שמוסיף עמלה","מדיניות ביטולים","החזר שלוקח עשרה ימים","ביטול חיוב","קבלה שמגיעה למייל","חשבון בדואר",
      "תפקיד שאף אחד לא מבין","יום גיבוש","מפגש כלל־חברה","שיחת הערכה","תקופת הודעה מוקדמת","חפיפה","יום שנה בעבודה","מטבחון","מקרר משותף","אוכל עם שם עליו",
      "שולחן לא קבוע","שולחן עמידה","ישיבת בוקר קצרה","חסימה ביומן","נא לא להפריע","תשובה שמאחרת","מייל דחוף בתשע בערב","הודעה בסוף שבוע","ערוץ שלא נקרא","עבודה בקבוצה",
      "קבוצת לימוד","יום פתוח","מבחן מתכונת","לוח חזרה למבחנים","יום ציונים","טקס סיום","שנת חופש","הלוואת סטודנט","עבודה ראשונה","שינוי קריירה",
      "עבודה בצד","תיק עבודות","המלצה","התמחות בלי שכר","מרשם חוזר","מרפאה בלי תור","בדיקה שנתית","עונת השפעת","תרגיל של פיזיותרפיה","יום בריאות"],
   5:["געגועים הביתה","מתוק־מר","דז׳ה וו","בדיחה פנימית","אזור הנוחות","צד חיובי","קריאת השכמה","רוח שנייה","כאבי גדילה","קן ריק",
      ...
      "מגדל קלפים","אפקט הדומינו","מעגל קסמים","קלי קלות","משחק ילדים","מלחמה קשה","קשה למלא את הנעליים","אגוז קשה לפיצוח","חשבון פתוח עם מישהו","תפוח שלא נופל רחוק מהעץ",
      "בבת עינו","הכבשה השחורה","זאב בודד","ציפור בוקר","ציפור לילה","צמח על הספה","פרפר חברתי","מוריד את האווירה","נהג מהמושב האחורי","יודע כול",
      "מתערב בכל דבר","רוצה לרצות את כולם","חייב לשלוט בהכול","יצור של הרגלים","מחפש על הראש","יודע לעשות הכול קצת","דג גדול בבריכה קטנה","כתף לבכות עליה","אוזן קשבת","יד עוזרת",
      "חוות דעת שנייה","חוש שישי","גלגל חמישי","היתרון שבזה","הצד הפחות טוב","ברכה מעורבת","מבט שני","חבר של ימי שמש","אהבה ישנה","מקרה אבוד",
      "סיפור ארוך","מתפוצץ מהר","לשון חדה","פרצוף פוקר","לא מראה כלום","לב כבד","יד קלה","יד תקיפה","יד חופשית","ספר פתוח",
      "דלת סגורה","הזמנה פתוחה","סירוב מוחלט","נחיתה רכה","התעוררות קשה","מבחן המציאות","הפתעה לא נעימה","הפתעה נעימה","תערובת של הכול","בקשה גדולה מדי",
      "שליחות סרק","חלום באספמיה","זיכרון רחוק","שלב חולף","רגע חולף","התחלה איטית","סיום חזק","יציאה שגויה","שכבת צבע חדשה","בריא לגמרי",
      "חיים חדשים","שינוי אווירה","אוויר צח","הד מהעבר","מסע במנהרת הזמן","הימים הטובים","זיכרון בוורוד","לקח שנקנה ביוקר","ללמוד בדרך הקשה","סטירה בפנים",
      "בעיטה בבטן","טפיחה על השכם","דחיפה קדימה","יתרון בהתחלה","פתיחה מהירה","מגרש שווה","יתרון לא הוגן","עלות נסתרת","יש בזה מלכוד","קצה חוט פתוח",
      "מבוי סתום","ניסיון אחרון","סיכוי להילחם","סיכוי קטן","סיכוי רחוק","דבר בטוח","הימור בטוח","ג׳וקר","סוס שחור","החלש שמנצח",
      "קאמבק","נפילה","עלייה ונפילה","אג׳נדה נסתרת","מניע נסתר","ניגוד עניינים","חיים כפולים","פנים כלפי חוץ","חיים פרטיים","עולם קטן",
      "מבט רענן","אמונה עיוורת","צ׳ק פתוח","פטור מיוחד","סעיף מילוט","עבודה בשלוף","עבודה בלחץ","עבודה כפוית טובה","גן עדן של שוטים","חיסכון מדומה",
      "תפוח רקוב","עסקה גרועה","קיפוח","נקודה נכונה","מכה בול","מחליף משחק","הגלגל מתהפך","מרוץ נגד הזמן","שעון מתקתק","ממש בסוף",
      "דדליין שזז","מטרה נעה","משנים את הכללים באמצע","חמקמק","חלקלק","מקח קשה","סחר הוגן","תן וקח","כביש דו־סטרי","רחוב חד־סטרי",
      "צומת דרכים","פרשת דרכים","צעד רחוק מדי","גשר שנשרף","פצע פתוח","צלקת שהחלימה","מפסיד גרוע","מנצח מנומס","ניצחון ריק","ניצחון מוסרי",
      "נחמה קטנה","מה שמציל את זה","תכונה מכפרת","פגם קטלני","עקב אכילס","החוליה החלשה","הצד החזק","טריק למסיבות","כישרון נסתר","פורח מאוחר",
      "נשמה זקנה","צעיר בלב","זר מוכר","מכר רחוק","חברות לא צפויה","פרידה איטית","שקט לא נוח","חברות מרחוק","חברות שדעכה","היסטוריה משותפת",
      "בסיס משותף","חילוקי דעות","להסכים לא להסכים","מחוות שלום","כלל לא כתוב","שאלה פתוחה","פרצוף רציני","צחוק של מבוכה","מבט יודע","מבט גנוב",
      "הצצה נוספת","מחשבה שנייה","מסקנה ידועה מראש","נבואה שמגשימה את עצמה","איזון בריא","סיכון הכרחי","סיכון מחושב","קפיצה לחושך","סיפור עצוב","סוף טוב"]
  };
  ...
  const EN_TOPICS = {
   ...
   food:{n:"At the table", w:["pizza","sandwich","carrot","kettle","teapot","watermelon","cucumber","olive","egg","honey","soup","popcorn","ice cream","pancake","cheese","yoghurt","lemon","onion","fork","knife","plate","bowl","frying pan","oven","jar","hungry","thirsty","starving","stuffed","a stolen chip","a split dessert","leftovers","comfort food","meal prep","a sugar crash","splitting the bill","a group order","a table for one","an acquired taste","a full plate","a piece of cake"],
     own:{3:["a family recipe","a picky eater","burnt toast","second helpings"],4:["a food delivery app","a tasting menu"]}},
   work:{n:"At work", w:["deadline","routine","a spreadsheet","an inbox","an out-of-office","a meeting that could have been an email","open plan","a lunch break","a commute","a pay rise","a CV","an interview","a promotion","a resignation","a notice period","a handover","a performance review","a hot desk","a stand-up meeting","a shared fridge","an office kitchen","a work anniversary","an urgent email at 9pm","micromanage","buzzword","red tape","burnout","the rat race","a glass ceiling","a thankless task","stapler","calendar","envelope","folder","notebook"],
     own:{2:["a lanyard","a swivel chair","the office coffee machine"]}},
   beast:{n:"Animals", w:["elephant","chicken","penguin","snail","giraffe","camel","donkey","hedgehog","owl","bat","crab","octopus","dolphin","mosquito","ant","bee","spider","parrot","turtle","kangaroo","squirrel","frog","lion","tiger","bear","wolf","fox","rabbit","mouse","goat","sheep","cow","nest","beehive","feather","a fish out of water","a lone wolf","an early bird","a night owl","the black sheep","a wolf in sheep’s clothing","a paper tiger"],
     own:{3:["a stray cat","a wagging tail","feeding time","a trip to the vet"],4:["a rescue dog","a cat video","a pet passport","a fish tank"]}},
   town:{n:"Out in town", w:["a traffic jam","roadworks","a parking fine","a speed camera","a queue-jumper","self-checkout","a receipt","a bus lane","a night bus","a bike lane","an electric scooter","a taxi app","rush hour","a season ticket","a ticket barrier","lost property","a level crossing","a diversion","a rented flat","a deposit","a mortgage","a long queue","a wrong turn","a detour","a missed train","the wrong stop","directions from a stranger","doorbell","elevator","staircase","gate","fence","brick","a one-way street","a crossroads","a small world"],
     own:{2:["a corner shop","a market stall","a bus shelter"],5:["the last bus home","a part of town you avoid"]}},
   cash:{n:"Money", w:["wallet","allowance","a mortgage","a deposit","a pay rise","splitting the bill","a subscription you forgot","a free trial","a discount code","a receipt","an impulse buy","buyer's remorse","a warranty","a returns policy","a standing order","a direct debit","an overdraft","a credit score","a loyalty card","a points scheme","a sale that is not a sale","a bulk buy","a bribe","a shopping list","an unpaid debt","small print","a booking fee","a refund that takes ten days","a student loan","the rat race","a fair share","a means to an end","a blank cheque","a hidden cost","a raw deal"],
     own:{2:["a coin","a piggy bank","a bank card"]}},
   film:{n:"At the cinema", w:["plot twist","spoiler","cliffhanger","popcorn","a viral video","a trending topic","an influencer","a clickbait headline","autoplay","a slow burn","a Trojan horse","a red herring","a turning point","the bigger picture","a happy accident","a familiar face","a dark horse","a happy ending","a foregone conclusion","camera","tripod","microphone","speaker","television","remote control","a bad joke","a story you have heard before"],
     own:{2:["a ticket","the back row","the lights going down"],3:["crying at the ending","the film everyone has seen but you","someone talking through the film"],4:["a sequel","subtitles","a trailer that shows everything","a post-credits scene"]}},
   kids:{n:"Growing up", w:["homework","a sleepover","a hand-me-down","a babysitter","a birthday card","a growth spurt","the school run","a packed lunch","parents' evening","a sleep schedule","tantrum","nickname","allowance","a school report","a permission slip","a note from your mother","a study group","a mock exam","results day","a graduation","teddy bear","doll","kite","skipping rope","skateboard","growing pains","a rite of passage","a late bloomer","a chip off the old block"],
     own:{2:["a scraped knee","a lunchbox","a bunk bed","a swing"]}},
   body:{n:"Body and health", w:["exhausted","a sick day","a nap","a lie-in","dizzy","out of breath","sleepy","a step count","a gym membership","a rest day","a sugar crash","a growth spurt","a fitness tracker","a step goal","a repeat prescription","a walk-in clinic","an annual check-up","flu season","a physio exercise","a wellbeing day","a digital detox","toothbrush","toothpaste","towel","soap","a hard pill to swallow","second wind","a clean bill of health","an Achilles heel","a new lease of life"],
     own:{3:["a waiting room","a plaster on a knee","a good night’s sleep"]}}
  };
  const HE_TOPICS = {
   ...
   food:{n:"על השולחן", w:["פיצה","כריך","גזר","קומקום","קנקן","אבטיח","מלפפון","זית","ביצה","דבש","מרק","פופקורן","גלידה","פנקייק","גבינה","יוגורט","לימון","בצל","מזלג","סכין","צלחת","קערה","מחבת","תנור","צנצנת","רעב","צמא","גווע ברעב","שבע מדי","צ׳יפס שנגנב מהצלחת","קינוח משותף","שאריות","אוכל מנחם","להכין אוכל מראש","צניחת סוכר","לחלק את החשבון","הזמנה משותפת","שולחן לאחד","טעם נרכש","צלחת מלאה","קלי קלות"],
     own:{3:["מתכון של סבתא","אכלן בררן","טוסט שרוף","מנה שנייה"],4:["אפליקציית משלוחים","תפריט טעימות"]}},
   work:{n:"בעבודה", w:["דדליין","שגרה","אקסל","תיבת דואר נכנס","אאוט אוף אופיס","ישיבה שיכלה להיות מייל","חלל פתוח","הפסקת צהריים","נסיעה לעבודה","העלאה במשכורת","קורות חיים","ראיון עבודה","קידום","מכתב התפטרות","תקופת הודעה מוקדמת","חפיפה","שיחת הערכה","שולחן לא קבוע","ישיבת בוקר קצרה","מקרר משותף","מטבחון","יום שנה בעבודה","מייל דחוף בתשע בערב","ניהול זעיר","מילת באזז","בירוקרטיה","שחיקה","מרוץ העכברים","תקרת זכוכית","עבודה כפוית טובה","שדכן","לוח שנה","מעטפה","תיקייה","מחברת"],
     own:{2:["תג עובד","כיסא מסתובב","מכונת הקפה במשרד"]}},
   beast:{n:"חיות", w:["פיל","תרנגולת","פינגווין","חילזון","ג׳ירפה","גמל","חמור","קיפוד","ינשוף","עטלף","סרטן","תמנון","דולפין","יתוש","נמלה","דבורה","עכביש","תוכי","צב","קנגורו","סנאי","צפרדע","אריה","נמר","דוב","זאב","שועל","ארנב","עכבר","עז","כבשה","פרה","קן","כוורת","נוצה","דג מחוץ למים","זאב בודד","ציפור בוקר","ציפור לילה","הכבשה השחורה","נמר של נייר"],
     own:{3:["חתול רחוב","זנב מכשכש","זמן אוכל","ביקור אצל הווטרינר"],4:["כלב מאומץ","סרטון חתולים","דרכון לחיית מחמד","אקווריום"]}},
   town:{n:"בעיר", w:["פקק","עבודות בכביש","דוח חניה","מצלמת מהירות","מישהו שעוקף בתור","קופה עצמית","קבלה","נתיב אוטובוסים","אוטובוס לילה","שביל אופניים","קורקינט חשמלי","אפליקציית מוניות","שעת עומס","כרטיס חופשי חודשי","שער כרטיסים","אבידות ומציאות","מפגש מסילה","מעקף","דירה בשכירות","פיקדון","משכנתא","תור ארוך","פנייה לא נכונה","עיקוף","רכבת שהחמצת","תחנה לא נכונה","הכוונה מזר","פעמון דלת","מעלית","מדרגות","שער","גדר","לבנה","רחוב חד־סטרי","צומת דרכים","עולם קטן"],
     own:{2:["מכולת","דוכן בשוק","תחנת אוטובוס"],5:["האוטובוס האחרון הביתה","שכונה שמעדיפים לעקוף"]}},
   cash:{n:"כסף", w:["ארנק","דמי כיס","משכנתא","פיקדון","העלאה במשכורת","לחלק את החשבון","מנוי ששכחת ממנו","תקופת התנסות חינם","קוד הנחה","קבלה","קנייה מתפרצת","חרטת קונים","אחריות","מדיניות החזרות","הוראת קבע","חיוב אוטומטי","מינוס בבנק","דירוג אשראי","כרטיס מועדון","צבירת נקודות","מבצע שהוא לא מבצע","קנייה בכמות","שוחד","רשימת קניות","חוב שלא הוחזר","האותיות הקטנות","דמי הזמנה","החזר שלוקח עשרה ימים","הלוואת סטודנט","מרוץ העכברים","החלק שלי","אמצעי למטרה","צ׳ק פתוח","עלות נסתרת","קיפוח"],
     own:{2:["מטבע","קופת חיסכון","כרטיס אשראי"]}},
   film:{n:"בקולנוע", w:["תפנית בעלילה","ספוילר","סוף פתוח","פופקורן","סרטון ויראלי","נושא חם","משפיען","כותרת מפתה","הפעלה אוטומטית","בערה איטית","סוס טרויאני","הסחת דעת מכוונת","נקודת מפנה","התמונה הגדולה","תקלה משמחת","פנים מוכרות","סוס שחור","סוף טוב","מסקנה ידועה מראש","מצלמה","חצובה","מיקרופון","רמקול","טלוויזיה","שלט","בדיחה גרועה","סיפור ששמעת כבר"],
     own:{2:["כרטיס","השורה האחורית","האורות שנכבים"],3:["לבכות בסוף","הסרט שכולם ראו חוץ ממך","מישהו שמדבר בסרט"],4:["סרט המשך","כתוביות","טריילר שמגלה הכול","סצנה אחרי הקרדיטים"]}},
   kids:{n:"ילדות", w:["שיעורי בית","שינה אצל חבר","בגד יד שנייה","בייביסיטר","כרטיס ברכה","קפיצת גדילה","הסעה לבית הספר","כריך לבית הספר","אסיפת הורים","שעות שינה","התקף זעם","כינוי","דמי כיס","תעודה מבית הספר","אישור הורים","פתק מאמא","קבוצת לימוד","מבחן מתכונת","יום ציונים","טקס סיום","דובי","בובה","עפיפון","חבל קפיצה","סקייטבורד","כאבי גדילה","טקס מעבר","פורח מאוחר","תפוח שלא נופל רחוק מהעץ"],
     own:{2:["ברך שרוטה","קופסת אוכל","מיטת קומתיים","נדנדה"]}},
   body:{n:"גוף ובריאות", w:["מותש","יום מחלה","נמנום","לישון עד מאוחר","מסוחרר","קצר נשימה","ישנוני","ספירת צעדים","מנוי לחדר כושר","יום מנוחה","צניחת סוכר","קפיצת גדילה","שעון כושר","יעד צעדים","מרשם חוזר","מרפאה בלי תור","בדיקה שנתית","עונת השפעת","תרגיל של פיזיותרפיה","יום בריאות","גמילה מהמסך","מברשת שיניים","משחת שיניים","מגבת","סבון","גלולה מרה","רוח שנייה","בריא לגמרי","עקב אכילס","חיים חדשים"],
     own:{3:["חדר המתנה","פלסטר על הברך","לילה של שינה טובה"]}}
  };
  /* ============ links ============
  ...
  const EN_LINKS = {
   ...
   pizza:{ n:"Pizza", w:["a slice","a box","cheese","a Friday night","sharing","the last piece"] },
   snow:{ n:"Snow", w:["white","silence","a shovel","a snowman","school closed","cold hands"] },
   airport:{ n:"An airport", w:["a passport","a queue","a gate number","a suitcase","a delay","saying goodbye"] },
   supermarket:{ n:"A supermarket", w:["a trolley","an aisle","a till","a list","free samples","forgetting one thing"] },
   thunderstorm:{ n:"A storm", w:["thunder","a flash","counting seconds","a power cut","rain on a window","a dog hiding"] },
   newborn:{ n:"A newborn", w:["no sleep","tiny socks","visitors","a name","crying at 4am","a photo sent to everyone"] },
   drivingtest:{ n:"A driving test", w:["mirrors","a stranger with a clipboard","a hill start","nerves","a roundabout","passing or not"] },
   garden:{ n:"A garden", w:["soil","a hose","weeds","a deck chair","bees","something you planted"] },
   exam:{ n:"An exam", w:["a clock on the wall","silence","a spare pen","a desk in rows","one hour left","the walk out"] },
   camping:{ n:"Camping", w:["a tent","rain","a torch","marshmallows","a bad night's sleep","no signal"] },
   spain:{ n:"Spain", w:["tapas","a siesta","flamenco","the sun","oranges","a late dinner"] },
   russia:{ n:"Russia", w:["snow","a fur hat","a long train","chess","the cold","a big country"] },
   china:{ n:"China", w:["a wall","chopsticks","a dragon","tea","a huge city","red"] },
   mexico:{ n:"Mexico", w:["chilli","a sombrero","cactus","tacos","a mariachi","the day of the dead"] },
   holland:{ n:"The Netherlands", w:["bicycles","tulips","canals","windmills","flat land","cheese"] },
   scotland:{ n:"Scotland", w:["bagpipes","a kilt","a loch","rain","whisky","a castle"] },
   norway:{ n:"Norway", w:["fjords","the northern lights","salmon","expensive","long nights","skiing"] },
   turkey:{ n:"Turkey", w:["a bazaar","strong coffee","a carpet","two continents","a hot bath","a call to prayer"] },
   spring:{ n:"Spring", w:["blossom","allergies","longer days","new leaves","cleaning","a first warm day"] },
   summer:{ n:"Summer", w:["a fan","sunburn","ice cream","late light","open windows","nothing to do"] },
   dawn:{ n:"Morning", w:["an alarm","coffee","a snooze button","light through a curtain","a slow start","the news"] },
   night:{ n:"Night", w:["a lamp","a last message","quiet streets","a full fridge","a film half-watched","tomorrow"] },
   bank:{ n:"A bank", w:["a queue","a form","a card","a small window","an interest rate","a pen on a chain"] },
   police:{ n:"The police", w:["a siren","a uniform","a statement","a blue light","a notebook","questions"] },
   court:{ n:"A courtroom", w:["a judge","an oath","two sides","a hammer","the truth","a verdict"] },
   theatre:{ n:"A theatre", w:["a curtain","a programme","the interval","a whisper","applause","the front row"] },
   museum:{ n:"A museum", w:["glass cases","do not touch","a school trip","quiet rooms","a gift shop","an old bone"] },
   zoo:{ n:"A zoo", w:["a fence","a keeper","children pointing","a hidden animal","peanuts","a map you cannot read"] },
   market:{ n:"A market", w:["shouting","fruit","a scale","haggling","plastic bags","fish on ice"] },
   pharmacy:{ n:"A pharmacy", w:["a white coat","a prescription","a small box","instructions","a queue of coughs","the same shelf every time"] },
   postoffice:{ n:"A post office", w:["a parcel","a stamp","a form","a queue","string","a slow window"] },
   funeral:{ n:"A funeral", w:["black","a speech","a photograph","standing in a row","weather that does not care","tea afterwards"] },
   newyear:{ n:"New Year", w:["a countdown","fireworks","a promise","a hug","an old calendar","staying up"] },
   moving:{ n:"Moving house", w:["boxes","tape","a van","an empty room","a new key","things you forgot you had"] },
   firstday:{ n:"A first day", w:["a name badge","not knowing anyone","a tour","being early","a desk","going home tired"] },
   election:{ n:"An election", w:["a queue","a slip of paper","a booth","a promise","a number on a screen","a long night"] },
   internet:{ n:"The internet", w:["a search box","a cat","an argument","a wire","a wait","everybody at once"] },
   electricity:{ n:"Electricity", w:["a switch","a bill","a wire","a shock","a bulb","everything stopping"] },
   glass:{ n:"Glass", w:["a window","breaking","see-through","a bottle","careful hands","a sharp edge"] },
   paper:{ n:"Paper", w:["a cut","a folded plane","a tree","a printer","a note","recycling"] },
   salt:{ n:"Salt", w:["the sea","too much","a shaker","preserving","tears","a small white grain"] },
   shadow:{ n:"A shadow", w:["the sun","following you","longer at evening","a wall","cool","nothing you can hold"] },
   mirror2:{ n:"A mirror", w:["a reflection","a bathroom","the left hand","checking twice","seven years","honesty"] },
   key:{ n:"A key", w:["a pocket","a lock","losing it","a spare","turning","being let in"] },
   bridge:{ n:"A bridge", w:["two sides","water below","crossing","engineering","a toll","not looking down"] },
   ladder:{ n:"A ladder", w:["rungs","a wall","climbing","not looking down","a painter","superstition"] },
   circle:{ n:"A circle", w:["no corners","a wheel","a ring","going round","the same place","no beginning"] },
   secretlink:{ n:"A secret", w:["one person","a whisper","a promise","weight","letting it out","not the same afterwards"] },
   patience:{ n:"Patience", w:["a queue","a kettle","a child","not shouting","a long game","waiting"] },
   luck:{ n:"Luck", w:["a coin","a number","being in the right place","a horseshoe","nothing you did","a story afterwards"] }
  };
  const HE_LINKS = {
   ...
   pizza:{ n:"פיצה", w:["משולש","קופסה","גבינה","ערב שישי","לחלוק","החתיכה האחרונה"] },
   snow:{ n:"שלג", w:["לבן","שקט","החרמון","איש שלג","בית ספר סגור","ידיים קפואות"] },
   airport:{ n:"נמל תעופה", w:["דרכון","תור","מספר שער","מזוודה","עיכוב","להיפרד"] },
   supermarket:{ n:"סופרמרקט", w:["עגלה","מעבר","קופה","רשימה","טעימות","לשכוח דבר אחד"] },
   thunderstorm:{ n:"סערה", w:["רעם","הבזק","לספור שניות","הפסקת חשמל","גשם על החלון","כלב שמתחבא"] },
   newborn:{ n:"תינוק חדש", w:["בלי שינה","גרביים קטנות","אורחים","שם","בכי בארבע לפנות בוקר","תמונה שנשלחת לכולם"] },
   drivingtest:{ n:"טסט", w:["מראות","טסטר","עלייה בהילוך","לחץ","כיכר","עובר או לא"] },
   garden:{ n:"גינה", w:["אדמה","צינור","עשבים","כיסא נוח","דבורים","משהו שנטעת"] },
   exam:{ n:"מבחן", w:["שעון על הקיר","שקט","עט רזרבי","שולחנות בשורות","שעה אחרונה","היציאה החוצה"] },
   camping:{ n:"קמפינג", w:["אוהל","גשם","פנס","מרשמלו","לילה בלי שינה","אין קליטה"] },
   spain:{ n:"ספרד", w:["טאפאס","סיאסטה","פלמנקו","שמש","תפוזים","ארוחת ערב מאוחרת"] },
   russia:{ n:"רוסיה", w:["שלג","כובע פרווה","רכבת ארוכה","שחמט","קור","מדינה ענקית"] },
   china:{ n:"סין", w:["חומה","מקלות אכילה","דרקון","תה","עיר עצומה","אדום"] },
   mexico:{ n:"מקסיקו", w:["צ׳ילי","סומבררו","קקטוס","טאקו","מריאצ׳י","חג המתים"] },
   holland:{ n:"הולנד", w:["אופניים","צבעונים","תעלות","טחנות רוח","שטח מישורי","גבינה"] },
   scotland:{ n:"סקוטלנד", w:["חמת חלילים","חצאית משבצות","אגם","גשם","וויסקי","טירה"] },
   norway:{ n:"נורווגיה", w:["פיורדים","זוהר צפוני","סלמון","יקר","לילות ארוכים","סקי"] },
   turkey:{ n:"טורקיה", w:["בזאר","קפה חזק","שטיח","שתי יבשות","חמאם","קריאה למסגד"] },
   spring:{ n:"אביב", w:["פריחה","אלרגיה","ימים ארוכים","עלים חדשים","ניקיון","יום חמים ראשון"] },
   summer:{ n:"קיץ", w:["מאוורר","כווייה מהשמש","גלידה","אור עד מאוחר","חלונות פתוחים","אין מה לעשות"] },
   dawn:{ n:"בוקר", w:["שעון מעורר","קפה","נודניק","אור מבעד לווילון","להתעורר לאט","חדשות"] },
   night:{ n:"לילה", w:["מנורה","הודעה אחרונה","רחובות ריקים","מקרר מלא","סרט שנרדמים בו","מחר"] },
   bank:{ n:"בנק", w:["תור","טופס","כרטיס","חלון קטן","ריבית","עט על שרשרת"] },
   police:{ n:"משטרה", w:["סירנה","מדים","עדות","אור כחול","פנקס","שאלות"] },
   court:{ n:"בית משפט", w:["שופט","שבועה","שני צדדים","פטיש","האמת","פסק דין"] },
   theatre:{ n:"תיאטרון", w:["מסך","תוכנייה","הפסקה","לחישה","מחיאות כפיים","השורה הראשונה"] },
   museum:{ n:"מוזיאון", w:["ויטרינות","אסור לגעת","טיול שנתי","חדרים שקטים","חנות מזכרות","עצם עתיקה"] },
   zoo:{ n:"גן חיות", w:["גדר","מטפל","ילדים שמצביעים","חיה שמתחבאת","בוטנים","מפה שאי אפשר להבין"] },
   market:{ n:"שוק", w:["צעקות","פירות","משקל","להתמקח","שקיות","דגים על קרח"] },
   pharmacy:{ n:"בית מרקחת", w:["חלוק לבן","מרשם","קופסה קטנה","הוראות","תור של משתעלים","אותו מדף כל פעם"] },
   postoffice:{ n:"דואר", w:["חבילה","בול","טופס","תור","חוט","חלון אחד פתוח"] },
   funeral:{ n:"לוויה", w:["שחור","הספד","תמונה","לעמוד בשורה","מזג אוויר אדיש","שבעה"] },
   newyear:{ n:"ראש השנה", w:["תפוח בדבש","רימון","שופר","ארוחה משפחתית","התחלה","ברכות"] },
   moving:{ n:"מעבר דירה", w:["קרטונים","נייר דבק","משאית","חדר ריק","מפתח חדש","דברים ששכחת שיש לך"] },
   firstday:{ n:"יום ראשון בעבודה", w:["תג עם שם","לא מכירים אף אחד","סיור","להגיע מוקדם","שולחן","לחזור הביתה עייף"] },
   election:{ n:"בחירות", w:["תור","פתק","פרגוד","הבטחה","מספר על מסך","לילה ארוך"] },
   internet:{ n:"אינטרנט", w:["תיבת חיפוש","חתול","ויכוח","כבל","המתנה","כולם בבת אחת"] },
   electricity:{ n:"חשמל", w:["מתג","חשבון","חוט","מכה","נורה","הכול נעצר"] },
   glass:{ n:"זכוכית", w:["חלון","נשברת","שקופה","בקבוק","ידיים זהירות","קצה חד"] },
   paper:{ n:"נייר", w:["חתך","מטוס מקופל","עץ","מדפסת","פתק","מיחזור"] },
   salt:{ n:"מלח", w:["הים","יותר מדי","מלחייה","לשמר","דמעות","גרגר לבן קטן"] },
   shadow:{ n:"צל", w:["שמש","הולך אחריך","מתארך לעת ערב","קיר","קריר","אי אפשר להחזיק"] },
   mirror2:{ n:"מראה", w:["השתקפות","אמבטיה","יד שמאל","לבדוק פעמיים","שבע שנים","כנות"] },
   key:{ n:"מפתח", w:["כיס","מנעול","לאבד","עותק","לסובב","להיכנס"] },
   bridge:{ n:"גשר", w:["שני צדדים","מים למטה","לחצות","הנדסה","אגרה","לא להסתכל למטה"] },
   ladder:{ n:"סולם", w:["שלבים","קיר","לטפס","לא להסתכל למטה","צבע","אמונה טפלה"] },
   circle:{ n:"מעגל", w:["בלי פינות","גלגל","טבעת","להסתובב","אותו מקום","בלי התחלה"] },
   secretlink:{ n:"סוד", w:["אדם אחד","לחישה","הבטחה","משקל","לשחרר","כבר לא אותו דבר"] },
   patience:{ n:"סבלנות", w:["תור","קומקום","ילד","לא לצעוק","משחק ארוך","לחכות"] },
   luck:{ n:"מזל", w:["מטבע","מספר","להיות במקום הנכון","פרסה","לא בזכותך","סיפור אחר כך"] }
  };
